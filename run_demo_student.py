...
from TSmodel import Student_model

#############################################################################################
parser = argparse.ArgumentParser(description='Test with pytorch')
#############################################################################################
parser.add_argument('--model_name', '-m', type=str, default='Student_model')
parser.add_argument('--weight_name', '-w', type=str, default='Student_model') # RTFNet_152, RTFNet_50, please change the number of layers in the network file
